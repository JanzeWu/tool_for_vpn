...
echo "# Intro: http://blog.wateroot.com                           #"
...
pre_install(){
    ...
    read -p "(Default password: wateroot.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="wateroot.com"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo
        echo "Welcome to visit:http://blog.wateroot.com"
        echo "Enjoy it!"
        echo
    else
